...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  openModeMenu: (payload) => ipcRenderer.invoke('open-mode-menu', payload),
  closeModeMenu: () => ipcRenderer.invoke('close-mode-menu'),
  getModeMenuState: () => ipcRenderer.invoke('get-mode-menu-state'),
  modeMenuAction: (payload) => ipcRenderer.invoke('mode-menu-action', payload),
  ...
  setLayoutMode: (layoutMode) => ipcRenderer.invoke('set-layout-mode', layoutMode),
  cycleLayoutMode: () => ipcRenderer.invoke('cycle-layout-mode'),
  ...
  onAppPreferencesUpdated: (callback) => subscribe('app-preferences-updated', callback),
